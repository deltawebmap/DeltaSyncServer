...
namespace ARKDinoDataReader.Tools
{
    public class IOMemoryStream
    {
        ...
        public DotArkLocationData ReadLocationData()
        {
            return DotArkLocationData.ReadLocationData(this);
        }

        public ArkClassName ReadArkClassname()
        {
            return ArkClassName.ReadFromFile(this);
        }
